module TsmRepr {
  float getReprScore(string repr, string t){
   ...
   repr = "(member * (parameter 0 (member populate *)))" and t = "snk" and result = 0.0493197280 or
   ...
   repr = "(member 3 (parameter match (member PSEUDO *)))" and t = "snk" and result = 0.0136054420 or
   repr = "(member _ST (parameter T (member getStyleText *)))" and t = "snk" and result = 0.0136054420 or
   ...
   repr = "(member attributes (instance (member element *)))" and t = "snk" and result = 0.0493197280 or
   repr = "(member attributes (parameter 1 (member createElement *)))" and t = "snk" and result = 0.0493197280 or
   ...
   repr = "(member expr (return (member find *)))" and t = "snk" and result = 0.0136054420 or
   repr = "(member height (member attributes *))" and t = "snk" and result = 0.5000000000 or
   ...
   repr = "(member innerHTML (instance (member Object (global))))" and t = "snk" and result = 1.0000000000 or
   ...
   repr = "(member innerHTML (member firstChild *))" and t = "snk" and result = 0.6250000000 or
   ...
   repr = "(member innerHTML (parameter 0 (member DisplayNode *)))" and t = "snk" and result = 1.0000000000 or
   repr = "(member innerHTML (parameter 0 (member LineChart *)))" and t = "snk" and result = 1.0000000000 or
   repr = "(member innerHTML (parameter 0 (member M_getParent (global))))" and t = "snk" and result = 1.0000000000 or
   repr = "(member innerHTML (parameter 0 (member M_showElement (global))))" and t = "snk" and result = 1.0000000000 or
   ...
   repr = "(member innerHTML (parameter 0 (member fromHTML *)))" and t = "snk" and result = 1.0000000000 or
   ...
   repr = "(member innerHTML (parameter 0 (member processLine *)))" and t = "snk" and result = 1.0000000000 or
   ...
   repr = "(member innerHTML (parameter 1 (member M_positionUserInfoPopup (global))))" and t = "snk" and result = 1.0000000000 or
   ...
   repr = "(member set (return (member find *)))" and t = "snk" and result = 0.0136054420 or
   ...
   repr = "(member style (member attributes *))" and t = "snk" and result = 0.1000000000 or
   repr = "(member style (parameter 0 (member extend *)))" and t = "snk" and result = 0.1000000000 or
   ...
   repr = "(member width (member attributes *))" and t = "snk" and result = 0.5000000000 or
   ...
   repr = "(parameter 0 (member * (member $this (global))))" and t = "snk" and result = 1.0000000000 or
   ...
   repr = "(parameter 0 (member addStyle *))" and t = "snk" and result = 0.0136054420 or
   ...
   repr = "(parameter 0 (member apply *))" and t = "snk" and result = 0.1318027210 or
   ...
   repr = "(parameter 0 (member compareDocumentPosition *))" and t = "snk" and result = 0.0136054420 or
   repr = "(parameter 0 (member contains *))" and t = "snk" and result = 0.0136054420 or
   ...
   repr = "(parameter 0 (member getElementById *))" and t = "snk" and result = 0.0136054420 or
   repr = "(parameter 0 (member getElementsByClassName *))" and t = "snk" and result = 0.0136054420 or
   repr = "(parameter 0 (member getElementsByTagName *))" and t = "snk" and result = 0.1318027210 or
   ...
   repr = "(parameter 0 (member parse *))" and t = "snk" and result = 0.0317736850 or
   ...
   repr = "(parameter 0 (member querySelectorAll *))" and t = "snk" and result = 0.3100907040 or
   ...
   repr = "(parameter 0 (parameter 0 (member isFunction *)))" and t = "snk" and result = 0.2500000000 or
   ...
   repr = "(parameter 0 (return (member replace *)))" and t = "snk" and result = 0.1000000000 or
   repr = "(parameter 0 (return (member require (global))))" and t = "snk" and result = 1.0000000000 or
   repr = "(parameter 0 (return (member stylesFilter *)))" and t = "snk" and result = 0.1000000000 or
   ...
   repr = "(parameter 1 (member createElement *))" and t = "snk" and result = 0.0289115650 or
   ...
   repr = "(parameter 1 (member filter *))" and t = "snk" and result = 0.0136054420 or
   ...
   repr = "(parameter 1 (member writeFileSync *))" and t = "snk" and result = 0.2875000000 or
   ...
   repr = "(parameter 3 (member push *))" and t = "snk" and result = 0.1785714300 or
   repr = "(parameter 4 (member append *))" and t = "snk" and result = 1.0000000000 or
   repr = "(return (member * (parameter 1 (member extend *))))" and t = "snk" and result = 0.3214285700 or
   repr = "(return (member PSEUDO *))" and t = "snk" and result = 0.0136054420 or
   ...
   repr = "(return (member contains *))" and t = "snk" and result = 0.0136054420 or
   repr = "(return (member convertUrlToDataUrl *))" and t = "snk" and result = 0.1428571400 or
   repr = "(return (member cookie *))" and t = "snk" and result = 0.4375000000 or
   repr = "(return (member createFakeElement *))" and t = "snk" and result = 0.0493197280 or
   repr = "(return (member css *))" and t = "snk" and result = 0.3750000000 or
   repr = "(return (member extend *))" and t = "snk" and result = 0.1000000000 or
   repr = "(return (member filter *))" and t = "snk" and result = 0.0136054420 or
   repr = "(return (member find *))" and t = "snk" and result = 0.0136054420 or
   ...
   repr = "(return (member htmlEncodeAttr *))" and t = "snk" and result = 0.1785714300 or
   repr = "(return (member matches *))" and t = "snk" and result = 0.0136054420 or
   ...
   repr = "(return (member uniqueSort *))" and t = "snk" and result = 0.1909013605 or
   ...
   repr = "(return (parameter 1 (member replace *)))" and t = "snk" and result = 0.1664399093 or
   repr = "(return (parameter 2 (member readFile *)))" and t = "snk" and result = 0.2500000000 or
   repr = "(return (return (member proxy *)))" and t = "snk" and result = 0.2500000000 or
   repr = "(return (return (member stylesFilter *)))" and t = "snk" and result = 0.1000000000
   } 
}
