module TsmRepr {
  float getReprScore(string repr, string t){
   ...
   repr = "(parameter 0 (member get *))" and t = "snk" and result = 0.3214285700 or
   ...
   repr = "(parameter 0 (parameter 0 (member isFunction *)))" and t = "snk" and result = 0.2142857150 or
   ...
   repr = "(return (member cookie *))" and t = "snk" and result = 0.3571428575 or
