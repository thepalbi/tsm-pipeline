// Rename SqlInjection as SqlInjectionWorse, assuming SqlInjection comes from a worse version of the
// CodeQL libraries
...
module SqlInjectionWorseTSM {
  ...
  class SqlInjectionWorseRepresentations extends TSM::Representations {
    ...
    /**
     * The list of TSM representations for SqlInjection injection along with their scores.
