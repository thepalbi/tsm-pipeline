...
import tsm.nosql.NosqlInjectionWorseTSMConfig as TSMConfig
...
query predicate compareNewV0vsWorseBoostedSinks(DataFlow::PathNode sinkNew, string rep, 
  ...
  exists(
      ...
      exists(TSMConfig::Configuration cfg| 
        ...
        // and ( 
        //   exists(API::Node imp | 
        //       imp = API::moduleImport(library)
        //       and isCandidateSink(sinkNew.getNode(), library)
        //       ) 
        //   or (
        //       not exists(API::Node imp, string lib | 
        //       imp = API::moduleImport(lib)
        //       and isCandidateSink(sinkNew.getNode(), lib) 
        //       ) 
        //       and library = "none" 
        //     )
        // )
...
query predicate compareMissedV0vsWorseBoostedSinks(DataFlow::PathNode sinkNew, 
              string rep, string library) {
  exists(
