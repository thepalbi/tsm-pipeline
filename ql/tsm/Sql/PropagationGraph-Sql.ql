...
private string npmLibraries() {
  result in ["sql", "sql.js", "sqlstring", "mssql", "mysql", "sequelize", "sqlite3",
        "better-sqlite3", "knex", "postgres", "oracledb", "tedious", "pretty-data", "db-migrate"]
}

private string packageListFromFrecuency() {
  result in ["express", "mysql", "body-parser", "process", "path", "fs", "http", "crypto",
...
private string targetLibraryWorse() {
  result in ["mysql", "pg", "sqlite3", "express", "azure-storage", "mssql", "process", "multiparty",
