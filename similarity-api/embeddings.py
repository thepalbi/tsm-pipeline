...
if __name__ == "__main__":
    ...
    locStm = Location("g/chaibio/chaipcr", "frontend/javascripts/libs/angular-sanitize.js",
                468, 7, 468, 69)
    locFunc = Location("g/chaibio/chaipcr", "frontend/javascripts/libs/angular-sanitize.js",
                    457, 5, 468, 69)
